...
import Fabio        from "../ghosts/Fabio.js";
...
export default class Demo {
    ...
    drawTitle() {
        ...
        this.ctx.save();
        this.ctx.font      = `4em "Poppins"`;
        this.ctx.textAlign = "right";

        this.ctx.textAlign = "right";
        this.ctx.fillStyle = "rgb(255, 213, 0)";
        this.ctx.fillText("PPX", left.x, left.y);
    ...
    initChase() {
        ...
        this.fabio.chaseDemo(dir, -12 * size, yPos);
    ...
    createPlayers() {
        ...
        this.fabio  = new DemoGhost(this.board, Fabio.text, Fabio.color);

        this.ghosts = [ this.blinky, this.pinky, this.inky, this.clyde,this.fabio ];
    }
    ...
    initFrighten() {
        ...
        this.fabio.frightenDemo(dir, speed);
    ...
    initPresent() {
        ...
        this.fabio.presentDemo(DemoData.present.dir);

        this.ghosts   = [ this.blinky ];
        this.others   = [ this.pinky, this.inky, this.clyde, this.fabio ];
        this.count    = 5;
