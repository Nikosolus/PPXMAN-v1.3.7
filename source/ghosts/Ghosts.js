...
export default class Ghosts {
    ...
    constructor(board, oldManager) {
        ...
        // @ts-ignore
        const fabioDots  = oldManager && oldManager.fabio  ? oldManager.fabio.dotsCount  : null;
        ...
        this.fabio       = new Fabio(board, canvas, fabioDots);
        ...
        this.inPen       = [ this.pinky, this.inky, this.clyde,this.fabio ];
    ...
    */
     ...
     * @param {(Blinky|Pinky|Inky|Clyde|Fabio)} ghost
     * @returns {Void}
     */
    addGhostToPen(ghost) {
