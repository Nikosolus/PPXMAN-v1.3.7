...
export default class HighScores {
    ...
    /**
     * Pacman High Scores constructor
     */
    constructor() {
     ...
     */
    displayTitles() {
        const div = this.createContent("name", "level", "score");
    ...
    displayScores() {
        for (let i = 1; i <= this.total; i += 1) {
            ...
            const div  = this.createContent(data.name, data.level.gameLevel, Utils.formatNumber(data.score, ","));
